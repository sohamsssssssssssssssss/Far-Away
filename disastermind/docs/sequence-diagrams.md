...
The React Native field app (`clients/field-app/`) implements
`fieldapp/contracts.py`. Emissions ride the durable outbox: terrestrial first,
then Iridium satellite fallback, then offline queue (Step 10).
